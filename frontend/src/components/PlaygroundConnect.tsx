...
const TokenConnect = ({
  ...
  return (
    <div className="flex left-0 top-0 w-full h-full bg-white/80 text-gray-900 dark:bg-black/80 dark:text-white items-center justify-center text-center">
      <div className="flex flex-col gap-4 p-8 bg-white dark:bg-gray-950 w-full text-gray-900 dark:text-white border-t border-gray-200 dark:border-gray-900">
        <div className="flex flex-col gap-2">
          <input
            value={url}
            onChange={(e) => setUrl(e.target.value)}
            className="text-gray-900 dark:text-white text-sm bg-transparent border border-gray-300 dark:border-gray-800 rounded-sm px-3 py-2"
            placeholder="wss://url"
          ></input>
          <textarea
            value={token}
...
export const PlaygroundConnect = ({
  ...
  return (
    <div className="flex left-0 top-0 w-full h-full bg-white/80 text-gray-900 dark:bg-black/80 dark:text-white items-center justify-center text-center gap-2">
